...
harsha = Customer(1,'harsha','harsha@gmail.com',9876543210,21,50000,750)
harsha.display_customer()
print("Loan Eligibility:",harsha.check_eligibility())


varsha = Customer(1,'varsha','varsha@gmail.com',9876543210,21,60000,600)
varsha.display_customer()
print("Loan Eligibility:",varsha.check_eligibility())
